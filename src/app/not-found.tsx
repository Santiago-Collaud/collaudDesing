...
export default function NotFound() {
  ...
  return (
    <div className="w-full h-screen relative overflow-visible font-sans text-[#f5f6fa]">
      <div className="w-full h-screen flex flex-col lg:flex-row items-center justify-center space-y-16 lg:space-y-0 space-x-8 2xl:space-x-0">
        <div className="w-full lg:w-1/2 flex flex-col items-center justify-center lg:px-2 xl:px-0 text-center">
            ...
            <p className="text-4xl md:text-5xl lg:text-6xl font-bold tracking-wider text-gray-300 mt-2">not found</p>
            <p className="text-lg md:text-xl lg:text-2xl text-gray-500 my-12">Tenemos un pequeño error</p>
            <div>
              <button
        ...
        <div className="w-1/2 lg:h-full flex lg:items-end justify-center p-4">
            <svg className="w-full text-blue-600" xmlns="http://www.w3.org/2000/svg" data-name="Layer 1" viewBox="0 0 1119.60911 699" href="http://www.w3.org/1999/xlink">
            ...
            <rect x="595.70294" y="231.77652" width="478.71308" height="267.83694" fill="#362e8bff"></rect>
            ...
            <ellipse cx="1066.53846" cy="654.13477" rx="7.87756" ry="2.42386" fill="#f2f2f2"></ellipse><circle cx="835.05948" cy="545.66686" r="11.51335" fill="#f2f2f2"></circle>
            ...
            <rect x="87.60911" y="135" width="250" height="86" fill="#3f3d56"></rect><rect x="87.60911" y="237" width="250" height="86" fill="#3f3d56"></rect>
            <rect x="87.60911" y="339" width="250" height="86" fill="#3f3d56"></rect><rect x="271.60911" y="150" width="16" height="16" fill="currentColor" opacity="0.4"></rect>
            <rect x="294.60911" y="150" width="16" height="16" fill="currentColor" opacity="0.8"></rect><rect x="317.60911" y="150" width="16" height="16" fill="currentColor"></rect>
            ...
            <rect x="317.60911" y="251" width="16" height="16" fill="currentColor"></rect><rect x="271.60911" y="352" width="16" height="16" fill="currentColor" opacity="0.4"></rect>
            <rect x="294.60911" y="352" width="16" height="16" fill="currentColor" opacity="0.8"></rect><rect x="317.60911" y="352" width="16" height="16" fill="currentColor"></rect>
            ...
            <path d="M394,661.5c0,7.732-19.90861,23-42,23s-43-14.268-43-22,20.90861-6,43-6S394,653.768,394,661.5Z" transform="translate(-31.39089 -100.5)" fill="#ff3737ff"></path>
            </svg>
          </div>
        <div>
      </div>
